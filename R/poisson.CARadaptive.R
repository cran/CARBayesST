poisson.CARadaptive <- function(formula, data = NULL, W, burnin, n.sample, thin = 1, prior.mean.beta = NULL, prior.var.beta = NULL, prior.tau2 = NULL, rhofix = NULL, epsilon = 0, verbose = TRUE)
    { 
  ...
  for(j in 1:n.sample){ 
    ...
    dev <- -2 * sum(deviance.all, na.rm=TRUE)   
