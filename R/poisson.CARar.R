poisson.CARar <- function(formula, data=NULL, W, burnin, n.sample, thin=1,  prior.mean.beta=NULL, prior.var.beta=NULL, prior.tau2=NULL, fix.rho.S=FALSE, rho.S=NULL, fix.rho.T=FALSE, rho.T=NULL, verbose=TRUE)
{
...
n.islands <- max(W.islands$nc)
  ...
  ## Start timer
    ...
    temp1 <- poissonarcarupdate(W.triplet, W.begfin, W.triplet.sum,  K, N, phi.mat, tau2, gamma, rho, Y.mat.miss, proposal.sd.phi, phi.offset, den.offset, which.miss.mat)      
    phi.temp <- temp1[[1]]
